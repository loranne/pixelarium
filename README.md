...
## Tags I used (alphetized, comma separated, **bold** for frequetnly used tags)
...
As is evident, this is all pretty memory heavy and slow, due to my building a database. 
